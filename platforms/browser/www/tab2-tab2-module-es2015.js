...
let Tab2Page = class Tab2Page {
    ...
    addEvent(courseName, eventName, startTime, endTime, allday) {
        ...
        this.eventService
            .addEvent(courseName, this.setFirstLetterToUppercase(eventName), this.formatTime(startTime), this.formatTime(endTime), allday)
            .then(() => {
    ...
    dateTime(t) {
        let time = Object(_angular_common__WEBPACK_IMPORTED_MODULE_3__["formatDate"])(t, "medium", this.locale);
