(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
    ...
    function srcAppServicesUserAuthServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var AuthService = /*#__PURE__*/function () {
        ...
        _createClass(AuthService, [{
          ...
          key: "signupUser",
          value: function signupUser(email, password, firstName, lastName) {
    ...
    /***/
    function srcAppServicesUserEventServiceTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var EventService = /*#__PURE__*/function () {
        function EventService() {
          ...
          firebase_app__WEBPACK_IMPORTED_MODULE_2__["auth"]().onAuthStateChanged(function (user) {
            if (user) {
              _this.eventListRef = firebase_app__WEBPACK_IMPORTED_MODULE_2__["firestore"]().collection("/userProfile/".concat(user.uid, "/eventList"));
            }
          });
        }
        ...
        _createClass(EventService, [{
          ...
          key: "modifyEvent",
          value: function modifyEvent(eventId, courseName, eventName, startTime, endTime, allDay) {
        ...
        function ProfileService() {
          ...
          firebase_app__WEBPACK_IMPORTED_MODULE_2__["auth"]().onAuthStateChanged(function (user) {
            if (user) {
              ...
              _this2.userProfile = firebase_app__WEBPACK_IMPORTED_MODULE_2__["firestore"]().doc("/userProfile/".concat(user.uid));
            }
          });
        }
        ...
        _createClass(ProfileService, [{
          ...
          value: function updateEmail(newEmail, password) {
            ...
            return this.currentUser.reauthenticateWithCredential(credential).then(function () {
              _this3.currentUser.updateEmail(newEmail).then(function () {
                _this3.userProfile.update({
                  email: newEmail
                });
              });
            })["catch"](function (error) {
          ...
          value: function updatePassword(newPassword, oldPassword) {
            ...
            return this.currentUser.reauthenticateWithCredential(credential).then(function () {
              _this4.currentUser.updatePassword(newPassword).then(function () {
