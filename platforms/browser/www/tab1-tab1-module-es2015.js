...
/* harmony import */ var src_app_services_user_event_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/services/user/event.service */ "./src/app/services/user/event.service.ts");
...
let Tab1Page = class Tab1Page {
    constructor(alertCtrl, locale, route, router, eventService, //call the services function
    platform) {
    ...
    listenChanges() {
        ...
        let slef = this;
        let db = firebase_app__WEBPACK_IMPORTED_MODULE_6__["firestore"]();
        db.collection(`/userProfile/${this.userId}/eventList`).onSnapshot({ includeMetadataChanges: true }, function (snapshot) {
            this.eventSource = [];
...
Tab1Page.ctorParameters = () => [
    ...
    { type: src_app_services_user_event_service__WEBPACK_IMPORTED_MODULE_9__["EventService"] },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["Platform"] }
];
Tab1Page.propDecorators = {
    myCal: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"], args: [ionic2_calendar__WEBPACK_IMPORTED_MODULE_2__["CalendarComponent"],] }]
};
