(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tab1-tab1-module"], {
    ...
    function srcAppPagesTab1Tab1PageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_services_user_event_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! src/app/services/user/event.service */
      "./src/app/services/user/event.service.ts");

      var Tab1Page = /*#__PURE__*/function () {
        function Tab1Page(alertCtrl, locale, route, router, eventService, //call the services function
        platform) {
          ...
          this.platform = platform; //events set
          ...
          value: function updateList() {
            ...
            .get().then(function (eventListSnapshot) {
              ...
              eventListSnapshot.forEach(function (snap) {
                var event = snap.data();
                event.id = snap.id;
                event.title = "".concat(snap.data().courseName, "-").concat(snap.data().eventName);
                event.startTime = _this9.transferDate(event.startTime);
                event.endTime = _this9.transferDate(event.endTime);

                _this9.eventSource.push(event);
              });
            });
          }
        }, {
          key: "transferDate",
          value: function transferDate(ISODateString) {
