                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 4:
                      ...
                      firstName = this.setFirstLetterToUppercase(signupForm.value.firstName); //get first name from the input field

                      lastName = this.setFirstLetterToUppercase(signupForm.value.lastName); //get last name from the input field
